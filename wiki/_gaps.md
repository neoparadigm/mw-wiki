...
| Topic Path | Title |
|---|---|
| `azure/app-proxy/app-proxy-configuration` | Azure App Proxy Configuration |
| `azure/avd/avd-security-baseline` | Azure Virtual Desktop Security Baseline |
| `azure/key-vault/key-vault-rbac` | Key Vault RBAC and Access Policy Migration |
| `defender/mde/edr-block-mode` | EDR in Block Mode |
| `defender/mde/tamper-protection` | MDE Tamper Protection |
...
| `identity/pim/pim-for-groups` | PIM for Groups Configuration |
| `intune/apps/winget-intune` | WinGet and Microsoft Store Integration |
...
| `sentinel/kql/identity-detection-queries` | KQL — Identity and Sign-in Detection |
...
| `teams/governance/app-permission-policies` | Teams App Permission Policies |
| `teams/security/external-access-federation` | Teams External Access and Federation Control |
